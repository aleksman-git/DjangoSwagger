...
class GetMethod(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="login_list")
    def list(self, request, *args, **kwargs):
        login_list = list(Login.objects.all().values())
        return Response(login_list)

    @swagger_auto_schema(operation_description="login_read")
...
class PasswordView(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="password_list")
    def list(self, request, *args, **kwargs):
    ...
    @swagger_auto_schema(operation_description="password_read")
    def retrieve(self, request, *args, **kwargs):
